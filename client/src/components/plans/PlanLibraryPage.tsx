...
## 双#号为注释行。注意英文逗号为分隔符，如果在内容中出现，请在两边使用英文双引号(excel会自动处理)。英文双引号不允许在内容中出现。Planname不同时，会生成多个计划,计划分类,课程代码、英文 唯一课程标识，可自定义,课程名称 - 和课程代码一一对应,具体内容描述,日期,开设时间,截至时间,教室位置,课程大类：语文、数学、英语、物理、化学、生物、历史、地理、计算机、艺术、运动、爱好等,高、中、低,标签，例如ACCP、TOEFL、羽毛球、篮球、钢琴、外教、中教等，多标签用英文逗号分隔
